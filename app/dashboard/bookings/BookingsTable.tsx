  ...
  if (loading) {
    return (
      <div className="space-y-4">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="bg-white dark:bg-zinc-900 p-6 rounded-lg shadow space-y-4">
            <div className="flex gap-4">
              <div className="w-[150px] h-[100px] bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse"></div>
